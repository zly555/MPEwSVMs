...
The goal of MPEwSVMs package is to perform the multiclass probability estimation with weighted SVMs, using the pairwise coupling, One-vs-All (OVA), and baseline learning algorithms from: "Zeng, L. and Zhang, H. H. (2022). Linear algorithms for nonparametric multiclass probability estimation". [(arXiv Link)](https://arxiv.org/abs/2205.12460).
...
Here we use an example to demonstrate the multiclass probability estimation with "MPEwSVMs" package. We adopt a three-class non-linear classification problem from [Zeng et al.](https://arxiv.org/abs/2205.12460v1)
simulation example 5 (page 18) for demonstration. 
